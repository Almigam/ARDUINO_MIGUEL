//EJERCICIO 11.1 EL BUCLE FOR Crear un programa que emita secuencias de destellos(10 destellos)
...
void loop() {                         //Función de principal
  ...
  for (int x=0; x<10; x++)            //inicializamos variable x a 1
                                      //mientras x menor 10, incrementamos 1
  {
